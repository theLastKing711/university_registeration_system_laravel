...
class Media extends \CloudinaryLabs\CloudinaryLaravel\Model\Media
{
    ...
    public static function fromCloudinaryUploadResponse(CloudinaryEngine $response_file, FileUploadDirectory $fileUploadDirectory): self
    {
        ...
        $media->collection_name = $fileUploadDirectory->value;
