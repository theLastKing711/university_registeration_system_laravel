...
use App\Data\Admin\Department\GetSemesterCourses\Response\GetSemesterCoursesResponseData;
...
class GetSemesterCoursesController extends Controller
{
    ...
    #[OAT\Get(path: '/admins/courses/departments/{id}/open-course-registerations', tags: ['adminsCourses'])]
