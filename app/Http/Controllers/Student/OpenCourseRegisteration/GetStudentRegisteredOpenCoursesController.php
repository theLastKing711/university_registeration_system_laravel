...
use App\Data\Student\OpenCourseRegisteration\QueryParameters\GetStudentRegisteredOpenCoursesData;
...
class GetStudentRegisteredOpenCoursesController extends Controller
{
    ...
    public function __invoke(GetStudentRegisteredOpenCoursesData $request)
    {
