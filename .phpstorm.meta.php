...
'debugbar.theme','debugbar.debug_backtrace_limit','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'data.commands.make.suffix','data.livewire.enable_synths','media-library.disk_name','media-library.max_file_size','media-library.queue_connection_name',
...
'l5-swagger::index','mail.test-email','vendor.l5-swagger.index','welcome','cloudinary::components.button',
'cloudinary::components.image','cloudinary::components.video','cloudinary::js','l5-swagger::index','laravel-exceptions-renderer::components.card',
...
'messages.exam_students.student unregistered in course','messages.open_coruse_registeraions.unfinished_required_prerequisites','messages.open_coruse_registeraions.duplicate_registered_course','pagination.previous','pagination.next',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','enum::C:.Users.beshe.OneDrive.Desktop.projects.university_registeration_system_laravel.vendor.spatie.laravel-enum.resources.lang.en.validation.enum','enum::C:.Users.beshe.OneDrive.Desktop.projects.university_registeration_system_laravel.vendor.spatie.laravel-enum.resources.lang.en.validation.enum_index',
